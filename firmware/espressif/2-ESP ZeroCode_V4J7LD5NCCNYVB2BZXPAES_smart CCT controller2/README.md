...
<img src="https://esp-ezc-launchpad-246098634217-prod.s3.us-east-1.amazonaws.com/companies/U58UVDGJP5SFPNCCCKSDAJ/products/V4J7LD5NCCNYVB2BZXPAES/721263253_1767680254/1/qr_code.png" alt="qr_code" width="30%" />
...
* **Setup mode**: LED shows a breathing pattern continuously, about 2 seconds per cycle, with white color.
* **Setup started**: LED shows a breathing pattern continuously, about 1 second per cycle, with white color.
* **Setup complete**: LED shows the default state of the device and stops any ongoing patterns.
* **Setup failed**: LED remains solid, with warm white color.
...
* **Identification okay**: LED blinks for 1 second, about 2 seconds per cycle, with white color.
* **Identification channel change**: LED blinks for 8 seconds, about 16 seconds per cycle, with white color.
